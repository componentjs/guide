...
Component tell you when your limit is running short via stdout. You can see an example at the [remotes.js travis build](https://travis-ci.org/componentjs/remotes.js/jobs/36446838). You get these information:
